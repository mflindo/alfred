function sendContact(){
    ...
    var pais = $("#contactform #pais").val();
    var msg = $("#contactform #msg").val();
    var html_datos;
    var html_final;

    if (validateText(name) && validateText(pais) && validateEmail(email)){
        html_datos = '<h2>Nueva Contacto vía Website<h3><h4>Datos Personales</h2><p>Nombre Cliente: ' +  name + '</p><p>Email: ' + email + '</p><p>País: ' + pais + '</p><p>Mensaje: ' + msg + '<p>';
        ...
        $("#pais").removeClass('required_field');
